...
namespace FoodSphere.Npgsql.Helper.Migrations
{
    ...
    [Migration("20260324045559_2026.03.24-11.55.41")]
    partial class _20260324115541
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodSphere.Common.Entity.Tag", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Type").HasValue("all");

                    b.UseTphMappingStrategy();
                });

            modelBuilder.Entity("FoodSphere.Common.Entity.TagIngredient", b =>
                {
                    b.Property<Guid>("RestaurantId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TagIngredient");
                });

            modelBuilder.Entity("FoodSphere.Common.Entity.TagMenu", b =>
                {
                    b.Property<Guid>("RestaurantId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FoodSphere.Common.Entity.IngredientTypeTag", b =>
                {
                    b.HasBaseType("FoodSphere.Common.Entity.Tag");

                    b.HasDiscriminator().HasValue("ingredient");
                });

            modelBuilder.Entity("FoodSphere.Common.Entity.MenuTypeTag", b =>
                {
                    b.HasBaseType("FoodSphere.Common.Entity.Tag");
            ...
            modelBuilder.Entity("FoodSphere.Common.Entity.TagIngredient", b =>
                {
                    ...
                    b.HasOne("FoodSphere.Common.Entity.IngredientTypeTag", "Tag")
                        .WithMany("TagIngredients")
            ...
            modelBuilder.Entity("FoodSphere.Common.Entity.TagMenu", b =>
                {
                    ...
                    b.HasOne("FoodSphere.Common.Entity.MenuTypeTag", "Tag")
                        .WithMany("TagMenus")
                        .HasForeignKey("RestaurantId", "TagId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("FoodSphere.Common.Entity.IngredientTypeTag", b =>
                {
                    b.Navigation("TagIngredients");
                });

            modelBuilder.Entity("FoodSphere.Common.Entity.MenuTypeTag", b =>
                {
                    b.Navigation("TagMenus");
                });
