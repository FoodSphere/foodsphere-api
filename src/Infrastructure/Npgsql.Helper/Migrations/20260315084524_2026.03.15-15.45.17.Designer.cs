...
namespace FoodSphere.Npgsql.Helper.Migrations
{
    ...
    [Migration("20260315084524_2026.03.15-15.45.17")]
    partial class _20260315154517
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FoodSphere.Common.Entity.Bill", b =>
                {
                    ...
                    b.Property<short?>("IssuerBranchId")
                        .HasColumnType("smallint");

                    b.Property<short?>("IssuerId")
                        .HasColumnType("smallint");

                    b.Property<Guid?>("IssuerRestaurantId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("IssuerRestaurantId", "IssuerBranchId", "IssuerId");
            ...
            modelBuilder.Entity("FoodSphere.Common.Entity.Bill", b =>
                {
                    ...
                    b.HasOne("FoodSphere.Common.Entity.WorkerUser", "Issuer")
                        .WithMany()
                        .HasForeignKey("IssuerRestaurantId", "IssuerBranchId", "IssuerId");

                    b.HasOne("FoodSphere.Common.Entity.WorkerUser", null)
                        .WithMany()
