...
public class SingleStaffResponse
{
    ...
    public static SingleStaffResponse FromModel(StaffUser model)
    {
        return new SingleStaffResponse
        {
            id = model.Id,
            restaurant_id = model.RestaurantId,
            name = model.Name,
...
public class SingleStaffPortalResponse
{
    ...
    public static SingleStaffPortalResponse FromModel(StaffPortal model)
    {
        return new SingleStaffPortalResponse
        {
            id = model.Id,
            restaurant_id = model.RestaurantId,
            staff_id = model.StaffId,
